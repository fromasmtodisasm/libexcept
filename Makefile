...
pkgdatadir = $(datadir)/libexcept
pkglibdir = $(libdir)/libexcept
pkgincludedir = $(includedir)/libexcept
...
LN_S = ln -s
LTLIB = @LTLIB@
MAKEINFO = /home/fraggle/libexcept/trunk/autotools/missing makeinfo
OBJDUMP = @OBJDUMP@
OBJEXT = o
PACKAGE = libexcept
RANLIB = ranlib
...
CONFIG_CLEAN_FILES =  libexcept-1.0.pc
DATA =  $(pkgconfig_DATA)

DIST_COMMON =  ./stamp-h.in COPYING INSTALL Makefile.am Makefile.in \
aclocal.m4 config.h.in configure configure.ac libexcept-1.0.pc.in
...
libexcept-1.0.pc: $(top_builddir)/config.status libexcept-1.0.pc.in
